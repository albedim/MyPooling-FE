            ...
            isLoading ? (
              ...
              !hasSelected ? (
                ...
                <div className="display-flex align-center overflow-x-scroll width-almost-full">
                  {
                    trips.map((trip) => (
                      <TripComponent time={trip.step.time} owner_usernam={trip.owner.user_id} step_id={trip.step.step_id} trip_id={trip.trip_id} username={trip.owner.username} departure_date={trip.departure_date} used_slots={trip.used_slots} slots={trip.slots} code={trip.code} />
                    ))
                  }
                </div>
              )
