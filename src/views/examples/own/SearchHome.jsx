  ...
  return (
    <div className="width-full height-full">
            ...
            <Row>
              <div className="width-full">
                <div className="margin-top-124 height-280 display-flex space-around align-center">
                  <div className="box-shadow-clearer white-backgroundcolor display-flex border-radius-5 height-90 width-640">
                    <div className="border-color-gray border-right-smaller height-90 width-240">
                      <div className="display-flex align-center height-44">
                        <span className="gray-color font-weight-500 font-size-11 font-family margin-left-14">DA DOVE PARTI</span>
                      </div>
      ...
      <div className="height-540">
        ...
        <div className="display-flex space-around height-280">
          {
            isLoading ? (
